...
//     const response_p = await fetch(`http://localhost:${server_PORT}/`);
//     const rankings = await response_p.json();
// }
...
async function fetch_rankings(){
    ...
    // let ranking_data = [];
    // ranking_data.push(rankings[0].score);
    // ranking_data.push(rankings[1].score);
    // ranking_data.push(rankings[2].score);
    // ranking_data.push(rankings[3].score);
    // ranking_data.push(rankings[4].score);
    // for(let i=0; i<5; i++){
